...
=======
    ...
    private void initComponents() {
        ...
        tblOrderDetail.setBackground(new java.awt.Color(255, 255, 255));
        tblOrderDetail.setForeground(new java.awt.Color(0, 0, 0));
        tblOrderDetail.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        btnAssignDeliveryMan.setBackground(new java.awt.Color(255, 255, 255));
        btnAssignDeliveryMan.setForeground(new java.awt.Color(0, 0, 0));
        btnAssignDeliveryMan.setText("Assign Delivery Man to Order");
        btnAssignDeliveryMan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAssignDeliveryManActionPerformed(evt);
